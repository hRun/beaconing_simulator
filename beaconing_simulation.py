...
if __name__ == "__main__":
    ...
    parser.add_argument("--socks_sessions", help="if protocol is set to HTTPSxSOCKS, start this many socks sessions over the duration of the beacon", type=int, default=4)
